...
public class Vector2D  {
	...
	{
		Vector2D vektor1 = new Vector2D(stala*this.x1, stala*this.y1, stala*this.x2, stala*this.y2);
		return vektor1;
	...
	{
		int xPolyArray[] = {(int)this.x2, (int)this.x2 - 3 , (int)this.x2 + 5, (int)this.x2 +3 , (int)this.x2 };
	...
	{
		int yPolyArray[] = {(int)this.y2, (int)this.y2 - 3 , (int)this.y2 - 6, (int)this.y2 +3 , (int)this.y2 };
